...
def get_args():
    parser = argparse.ArgumentParser(description='IBT-PNS Sentiment Analysis')
    ...
    # 跨模态注意力部分
    #parser.add_argument('--kernel_sizes', choices=[[5,4,3,2,1],[3,3,2,2,1],[2,2,1,1,1]],default=[3,2,1,1,1], help="kernel size in foldformer")
    parser.add_argument('--ratio', choices=[2,3,4],default=2, help="ratio in memorybank_size // batch_size")
    parser.add_argument('--threshold',type=float, default=1.0,help="threshhold for wrongly classification")
    parser.add_argument('--balance_hyper',type=float,default=1.0,help="balancing the sufficiency and necessity")
    ...
    parser.add_argument('--eta1', type=float, default=0.1, help='weight for infonce_loss')
    parser.add_argument('--eta2', type=float, default=0.1, help='weight for head_loss')
    parser.add_argument('--eta3', type=float, default=0.1, help='weight for kl_loss')
    parser.add_argument('--eta4', type=float, default=0.1, help='weight for PNS_mapping_loss')
    parser.add_argument('--eta5', type=float, default=0.0, help='weight for unimodal_loss(only for sims)')
